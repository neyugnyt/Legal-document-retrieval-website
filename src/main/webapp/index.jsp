...
<nav aria-label="Page navigation example">
	<ul class="pagination">
		...
		<li class="page-item"><a class="page-link"
			href="<%=request.getContextPath()%>/GetData?searchQuery=<%=searchQuery%>&pageNumber=<%=currentPage - 1%>">Previous</a>
		</li>
		<%
		}
		...
		<li class="page-item <%=activeClass%>"><a class="page-link"
			href="<%=request.getContextPath()%>/GetData?searchQuery=<%=searchQuery%>&pageNumber=<%=i%>"><%=i + 1%></a>
		</li>
		<%
		}
		// Next button
		...
		%>
		<li class="page-item"><a class="page-link"
			href="<%=request.getContextPath()%>/GetData?searchQuery=<%=searchQuery%>&pageNumber=<%=currentPage + 1%>">Next</a>
		</li>
		<%
		}
		%>
...
%>
<a href="http://localhost:8080/JavaWebApplication/Indexing">Indexing Database</a>
