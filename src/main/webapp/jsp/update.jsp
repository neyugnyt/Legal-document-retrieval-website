...
<body>
	<div class="update-container">
		<div class="form-group">
			<a href="http://localhost:8080/JavaWebApplication/GetUsers?pageNumber=0"><button style="background-color: red; margin-left: 350px;">X</button></a>
		</div>
		<form method="post"
			action="http://localhost:8080/JavaWebApplication/UpdateUser">
		...
		<%
		String res = (String) session.getAttribute("update");
		%>
		<%
		if (res != null) {
		%>
